...
import { openSearchAtom } from './pages/search/store';
import { colorSchemeAtom, openSettingsAtom } from './pages/settings/store';
import { SearchPage } from './pages/search/page';
import { openQueryAtom } from './pages/detail/store';
